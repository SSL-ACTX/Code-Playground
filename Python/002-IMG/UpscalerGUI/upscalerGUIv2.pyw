...
def upscale_image():
    ...
    if color_correct_var.get():
        ...
        brightened_image = sharpened_image
...
input_path_label = tk.Label(root, text="Image Path:", bg="#121212", fg="white")
...
input_path_button = tk.Button(root, text="Open", command=open_file, bg="#2f2f2f", fg="white", activebackground="#1f1f1f", activeforeground="white", bd=0)
input_path_button.grid(row=0, column=2, columnspan=3, pady=5, padx=5)
...
sharpen_label = tk.Label(root, text="Sharpening Level:", bg="#121212", fg="white", padx=10)
sharpen_label.grid(row=3, column=0, pady=5)

sharpen_entry = tk.Entry(root, bg="#242424", fg="white")
sharpen_entry.grid(row=3, column=1)

color_correct_var = tk.BooleanVar(value=True)

color_correct_checkbox = tk.Checkbutton(root, text="Color Correction", variable=color_correct_var, bg="#121212", fg="white", selectcolor="#121212")
color_correct_checkbox.grid(row=5, column=1, padx=10, pady=5)

upscale_button = tk.Button(root, text="Upscale", command=upscale_image, bg="#2f2f2f", fg="white", activebackground="#1f1f1f", activeforeground="white", bd=0)
upscale_button.grid(row=6, column=1, pady=10, padx=5, sticky='s')
